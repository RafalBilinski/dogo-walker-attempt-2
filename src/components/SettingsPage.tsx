      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="mb-4">
          ...
          <select
            ...
            onChange={(e) => setSettings({...settings, locationVisibility: e.target.value as 'everyone' | 'friends' | 'none'})}
          ...
          <p className="text-sm text-gray-500 mt-1">
            Who can see your location on the map
          </p>
        </div>
        ...
        <div className="mb-4">
          ...
          <select
            ...
            onChange={(e) => setSettings({...settings, profileVisibility: e.target.value as 'everyone' | 'friends'})}
            className="w-full p-2 border rounded"
          >
            <option value="everyone">Everyone</option>
            <option value="friends">Friends Only</option>
        ...
        <div className="mb-4">
          ...
          <select
            ...
            onChange={(e) => setSettings({...settings, defaultTab: e.target.value as 'map' | 'findBuddy' | 'profile'})}
            className="w-full p-2 border rounded"
          >
