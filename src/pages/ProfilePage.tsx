          ...
          <div className="flex-1">
            ...
            {isEditing ? (
              ...
              <div>
                ...
                {userData?.bio ? (
                  <p className="mt-2"><span className="font-bold">Bio: </span>{userData.bio}</p>
                ) : (
                  <p className="text-gray-500 italic mt-2">No bio provided. Click 'Edit Profile' to add one.</p>
                )}
              </div>
            )}
          </div>
